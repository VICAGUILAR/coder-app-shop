...
const controler = [
    ...
    { id: 4, image: "https://shop.hercules.com/pub/media/catalog/product/cache/f32e6b920edcd12f3fe95d79cda907cf/o/n/onlinecontent-djci500whiteedition_2000x2000-notext-3.jpg", category: "dj", title: "DJControl Inpulse 500 White Edition", price: "$6,000", description: "Controladora de DJ USB de 2 decks para Serato DJ Lite y DJUCED (incluidos) — interfaz de audio integrado, 16 pads RGB retroiluminados, jog wheels grandes, mezclador de entrada integrado en hardware y patas retráctiles."},
